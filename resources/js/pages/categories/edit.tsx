    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                <PageHeader title="Edit Kategori" description={`Edit kategori ${category.name}`} />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Kursi" {...field} onChange={handleNameChange} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Textarea placeholder="Deskripsi kategori" {...field} value={field.value ?? ''} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
