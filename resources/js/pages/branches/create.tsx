...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Cabang', href: '/branches/create' },
];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                <PageHeader title="Tambah Cabang" description="Buat cabang baru untuk toko Anda" />

                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>Informasi Cabang</CardTitle>
                        <CardDescription>Masukkan detail cabang baru</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
